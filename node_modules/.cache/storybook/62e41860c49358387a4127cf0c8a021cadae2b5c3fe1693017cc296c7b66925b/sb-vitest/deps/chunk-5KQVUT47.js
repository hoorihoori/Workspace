import {
  Tn,
  ha
} from "./chunk-5XPNZX64.js";
import {
  renderElement,
  unmountElement
} from "./chunk-MLKV36VW.js";
import {
  AddIcon,
  ChevronDownIcon,
  ChevronRightIcon,
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-XJ7LVT6Q.js");
...
function Xe(n2 = "", i22 = {}) {
  function u2(e2, n3, ...r2) {
    ...
    })(e2, i22.overrides), t({}, n3, l2, { className: Qe2(n3?.className, l2.className) || void 0 }), ...r2);
  }
  function Z22(e2) {
    e2 = e2.replace(w, "");
    let t2 = false;
...
`, { inline: t2 }));
  ...
  i22.overrides = i22.overrides || {}, i22.sanitizer = i22.sanitizer || He, i22.slugify = i22.slugify || Le, i22.namedCodesToUnicode = i22.namedCodesToUnicode ? t({}, o2, i22.namedCodesToUnicode) : o2, i22.createElement = i22.createElement || React21.createElement;
  let Q22 = [], V2 = {}, X2 = { [r.blockQuote]: { match: De(p2), order: 1, parse(e2, t2, n3) {
...
` }, [r.paragraph]: { match: Me2(Ne), order: 3, parse: Ge, render: (e2, t2, n3) => u2("p", { key: n3.key }, t2(e2.children, n3)) }, [r.ref]: { match: Re(P), order: 0, parse: (e2) => (V2[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: qe }, [r.refImage]: { match: Ie(_), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("img", { key: n3.key, alt: e2.alt, src: i22.sanitizer(V2[e2.ref].target, "img", "src"), title: V2[e2.ref].title }) : null }, [r.refLink]: { match: Re(F), order: 0, parse: (e2, t2, n3) => ({ children: t2(e2[1], n3), fallbackChildren: e2[0], ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("a", { key: n3.key, href: i22.sanitizer(V2[e2.ref].target, "a", "href"), title: V2[e2.ref].title }, t2(e2.children, n3)) : u2("span", { key: n3.key }, e2.fallbackChildren) }, [r.table]: { match: De(H), order: 1, parse: Te2, render(e2, t2, n3) {
    let r2 = e2;
...
var index_modern_default = (t2) => {
  ...
  return React21.cloneElement(Xe(r2, i22), l2);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-CWKMKOJH.js"));
...
//# sourceMappingURL=chunk-5KQVUT47.js.map
